/** Renders the shared bordered admin content surface using any semantic element. */
...
/** Renders one dashboard metric with supporting detail and optional trend. */
...
/** Renders a compact semantic status label using the requested visual tone. */
...
/** Groups admin list filters in the shared responsive toolbar surface. */
