...
/** Provides the shared visual structure for admin loading, error, and empty states. */
...
/** Renders the standard admin loading state. */
...
/** Renders a recoverable admin error state with an optional action. */
...
/** Renders an empty admin result with an optional next action. */
