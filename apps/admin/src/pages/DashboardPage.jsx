...
import { RecentOrders } from "../features/orders/components/RecentOrders.jsx";
...
export function DashboardPage() {
  ...
  return <>
    ...
    {!query.isError ? <div className="mt-6"><AnalyticsSummaryCards data={query.data} range={dashboardRange} loading={query.isPending} /></div> : null}
    ...
    {query.isSuccess ? <OrderActivitySummary data={query.data} /> : null}
    <RecentOrders />
  </>;
}
