...
export function HomePage() {
  ...
  return <>
    ...
    <section id="about" className="scroll-mt-24 bg-brand-950 py-16 text-white sm:py-20"><Container className="grid items-center gap-10 lg:grid-cols-2"><div><p className="text-xs font-bold uppercase tracking-[0.2em] text-green-300">About Nuede</p><h2 className="mt-4 max-w-xl font-display text-4xl leading-tight sm:text-5xl">Food for the way you live.</h2></div><div className="max-w-xl space-y-4 text-base leading-8 text-white/80"><p>Nuede brings prepared meals and practical nutrition together in Abuja. We believe choosing food should be a pleasure, with enough information to find what works for your appetite and your day.</p><p>Explore our meals, compare the available nutrition and customize eligible options. Order for today or bring several days together in a meal plan, then review delivery options at checkout.</p><Button to={storefrontPaths.menu} className="mt-2">Find your next meal</Button></div></Container></section>
