...
function NutritionPreview({ nutrition, complete }) {
  const values = [
    nutrition.calories === null ? null : `${nutrition.calories} kcal`,
    nutrition.proteinG === null ? null : `${nutrition.proteinG}g protein`,
    nutrition.carbohydratesG === null ? null : `${nutrition.carbohydratesG}g carbs`,
    nutrition.fatG === null ? null : `${nutrition.fatG}g fat`,
  ].filter(Boolean);
